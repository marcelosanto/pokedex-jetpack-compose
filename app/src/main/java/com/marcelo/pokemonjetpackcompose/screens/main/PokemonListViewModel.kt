...
import com.marcelo.pokemonjetpackcompose.model.PokedexListEntry
...
import com.marcelo.pokemonjetpackcompose.utils.Const.PAGE_SIZE
...
class PokemonListViewModel @Inject constructor(private val repository: PokedexRepository) :
    ...
    fun loadPokemonPaginated() {
        viewModelScope.launch {
            ...
            val result = repository.getAllPokemonList(PAGE_SIZE, curPage * PAGE_SIZE)
            when (result) {
                is Resource.Success -> {
